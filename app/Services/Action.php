...
class Action
{
     ...
     * @throws CustomException
     */
    protected function get_data_from_request (Request $request, string|array $validation_role, array $options = []): array
    {
    ...
    protected function get_by_request (
        Request             $request,
        string|array        $query_validation_role = 'get_query',
        null|Model|Builder  $eloquent = null,
...
//        $eloquent = $this->add_order_to_eloquent($order_by, $eloquent);
     ...
     */
    protected function query_to_eloquent (array $query, Builder|Model $eloquent = null)
    {
        if (is_null($eloquent))
        {
